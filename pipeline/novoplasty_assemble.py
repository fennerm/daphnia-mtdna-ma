...
from fmbiopy.fmgz import gzip, gunzip
from fmbiopy.fmpaths import paths_to_string
from fmbiopy.fmsystem import mkdir, mkdirs, working_directory, concat

# NOVOPLASTY Parameters
INSERT_SIZE = 320
INSERT_SIZE_AUT = 'yes'
TYPE = 'mito'
GENOME_RANGE = '14000-16000'
K_MER = 80
INSERT_RANGE = 1.6
...
if __name__ == "__main__":
    ...
    for i in range(len(isolates)):
        ...
        novoplasty(isolates[i], isolate_dirs[i], controls, read_length, seed)
